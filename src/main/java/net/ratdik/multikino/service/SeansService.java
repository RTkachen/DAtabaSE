...
public class SeansService {
    ...
    public SeansService(SeansRepository r) { this.repo = r; }

    public List<Seans> findAll() { return repo.findAll(); }

    @Transactional
    public Seans save(Seans s) { return repo.save(s); }

    @Transactional
    public void delete(Integer id) { repo.deleteById(Long.valueOf(id)); }
